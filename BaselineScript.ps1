...
$Output | Add-Member -MemberType NoteProperty -Name 'Date' -Value
$Date
...
$Output | Add-Member -MemberType NoteProperty -Name 'Network Adapter' -Value
$NetworkAdapterinfo

$Output | Add-Member -MemberType NoteProperty -Name 'Users' -Value
$Listofusers

$Output | Add-Member -MemberType NoteProperty -Name 'Services' -Value
$Services = Get-Service | Format-Table -Property Name,Status

$Output | Add-Member -MemberType NoteProperty -Name 'Processes' -Value
$Process

$Output | Add-Member -MemberType NoteProperty -Name 'Physical' -Value
$Physical

$Output | Add-Member -MemberType NoteProperty -Name 'AV' -Value
$AV

$Output | Add-Member -MemberType NoteProperty -Name 'Connections' -Value
$Connections

$Output | Add-Member -MemberType NoteProperty -Name 'Local Users' -Value
$Localusr
